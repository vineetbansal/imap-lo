...
#    $python $pydir/calcEfficiencies-RATE-TOF-BD.py -f $fileRAWCNT -b $fileTOFBD -m $mcpLo $mcpHi > "$outdir"/mcpGainReport.txt
    ...
    $python $pydir/hist_auto_gt_V5.py -f $file -e $file_de -k $file_hk -n 1 -a 7 -d 100 -t90 0.014 -toff1 0.0175 -toff2 0.0112 -tram90 0.028 -tramoff1 0.0350 -tramoff2 0.0224
    # multiplied each cut rate by x2 on June 4, 2026

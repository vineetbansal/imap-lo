...
for esa in range(1,8):
    ...
    n = len(TOF1)
    if (n < minEvents):
        print("1S08 checkdist Failed total number of events = ", n, "esa = ", esa)
        continue
...
#print("valid args:", args.valid)
    ...
    ncheck = len(x0)
    if (ncheck < minEvents): 
        print("1S08 checksumDist Failed number of events after valid selection = ", ncheck, "esa = ", esa)
        continue
    ...
    ncheck = len(x)
    if ncheck < minEvents:
        print("1S08 Checksum Failed number of events after TOF window = ", ncheck, "esa = ", esa)
        continue
   ...
   # print("number of valid TOF3 = ", nValid3)
    ...
    ncheck = len(xx)
    if (ncheck < minEvents): 
        print("1S08 Checksum Failed number of events after valid selection = ", ncheck, "esa = ", esa)
        continue

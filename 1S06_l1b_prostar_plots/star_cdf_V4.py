...
# NAS: taken out the correction since the code has een validated (8/31/2026)
STAR_SYNC_SHIFT_DEG = 0.00
...
STAR_SYNC_SDC_SHIFT_DEG = +0.00

# mounting shift 
# this is associated with the mounting of the instrument  (NAS, 8/31/2026)
MOUNTING_SHIFT_DEG = -0.26
...
if (repoint >= STAR_SYNC_FIRST_REPOINT) and (repoint <= STAR_SYNC_LAST_REPOINT):

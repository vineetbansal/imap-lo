...
spinbin_max = np.nanmax(spinbinA)

if spinbin_max <= 59:
    print("WARNING: spinbin appears to be 0–59 six-degree bins.")
    spin_angleA = 3.0 + 6.0 * spinbinA
elif spinbin_max <= 3600:
    print("spinbin appears to be 0–3599 tenth-degree bins.")
    spin_angleA = spinbinA * 360.0 / 3600.0
else:
    raise ValueError(f"Unexpected spinbin max: {spinbin_max}")

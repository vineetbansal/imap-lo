...
label_map = {
    ...
    "scfr_mflx": "Masked SC Frame Intensity (counts cm$^{-2}$ s$^{-1}$ sr$^{-1}$ keV$^{-1}$)",

    "scfr_flux": "SC Frame Intensity (counts cm$^{-2}$ s$^{-1}$ sr$^{-1}$ keV$^{-1}$)",

    "scfr_oflx": "SC Frame Ox Intensity (counts cm$^{-2}$ s$^{-1}$ sr$^{-1}$ keV$^{-1}$)",
...
#            "rate": f"map_rate_{esa}_Hy_sput_cor.csv",
            "scfr_mflx": f"map_flux_{esa}_Hy_scfr_msk.csv",
            "scfr_flux": f"map_flux_{esa}_Hy_scfr_nco.csv",

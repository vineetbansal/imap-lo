...
label_map = {
    ...
    "cg_flux": "CG Corrected Intensity (counts cm$^{-2}$ s$^{-1}$ sr$^{-1}$ keV$^{-1}$)",

    "cg_func": "Sys CG Uncertainty Intensity (counts cm$^{-2}$ s$^{-1}$ sr$^{-1}$ keV$^{-1}$)",

    "bg_flux": "BKG CG Corrected Intensity (counts cm$^{-2}$ s$^{-1}$ sr$^{-1}$ keV$^{-1}$)",

    "bg_func": "BKG Sys CG Uncertainty Intensity (counts cm$^{-2}$ s$^{-1}$ sr$^{-1}$ keV$^{-1}$)",
    ...
    "cg_fvar": "CG Corrected Intensity Variance (counts$^{2}$ cm$^{-4}$ s$^{-2}$ sr$^{-2}$ keV$^{-2}$)",

    "bg_fvar": "CG Corrected Intensity Variance (counts$^{2}$ cm$^{-4}$ s$^{-2}$ sr$^{-2}$ keV$^{-2}$)"
}

for pp in [75,90,105]:   # 

    work_dir1 = f'./outdir/pivot_{pp}/maps'
    plot_dir = f'./outdir/pivot_{pp}/cg_plots'
    ...
    for esa in range(1,8):
        ...
        files = {
            "cg_flux": f"map_cgflux_esa{esa}.csv",
            "cg_func": f"map_cgfunc_esa{esa}.csv",
            "cg_fvar": f"map_cgfvar_esa{esa}.csv",
            "bg_flux": f"bkg_cgflux_esa{esa}.csv",
            "bg_func": f"bkg_cgfunc_esa{esa}.csv",
            "bg_fvar": f"bkg_cgfvar_esa{esa}.csv",
        }

 ...
 # N = len(met) (number of events)
    ...
    #        esa_check = esa_flags[]
        ...
        # Combine checks per event per interval
            mask =  esa_check & absent_check & mode_check & tof0_check & tof1_check & tof2_check    # shape (N_events, N_goodtimes)
    ...
    #    print(mask[0:20])
        ...
        # -------------------------------
            ...
            print(f"1S20 species={species}: ESA = {esa}, Filtered {mask.sum()} / {N} rows written to {out_file}_ESA{esa}.csv")

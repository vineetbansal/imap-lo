...
with open(f'output/imap_lo_position_{date1}.csv', 'w') as fle:
    ...
    print_coord(fle, date1, spin_axis, lon_sc, lat_sc, lon_sc3, lat_sc3, lon_ephem, lat_ephem, lon_spin, lat_spin, lon_spin_eq, lat_spin_eq, diag["sc_position"], diag["sc_velocity"], diag["spin_angle"])

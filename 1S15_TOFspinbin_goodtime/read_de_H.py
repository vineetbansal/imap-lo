...
#                esa_check = esa_flags[]
        ...
        # Combine checks per event per interval
            event_pass =  esa_check & absent_check & mode_check & met_check & spin_check & tof0_check & tof1_check & tof2_check & tof3_check   # shape (N_events, N_goodtimes)
    ...
    #    print(mask[0:20])
        ...
        # -------------------------------
            ...
            print(f"1S15: ESA = {esa}, Filtered {mask.sum()} / {N} rows written to {out_file} + ESA")
